...
export class Backend implements backendInterface {
    ...
    async addDocument(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addDocument(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDocumentsBySection(arg0: string): Promise<Array<Document>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDocumentsBySection(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPendingOTPs(): Promise<Array<OTPEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingOTPs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async requestOTP(arg0: string, arg1: string): Promise<OTPEntry> {
        if (this.processError) {
            try {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        classSection: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.classSection)),
        name: value.name,
        registrationNumber: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.registrationNumber))
    };
}
